...
about_button.onclick = function(e) {
  ...
  .animate({
    ...
    main_container.innerHTML = '<div class="container-fluid"><div class="row row-eq-height"><div class="col-md-8"><h1 id="about-title">Developer &amp; Designer <br> of <br> Digital   <img src="images/emoji.png" alt="Joy" style="padding-left:10px;"> </h1></div><div class="col-md-4"><div class="circular-about-me"></div></div></div><div class="row"><div class="col-md-8 about-main-first"><p>Hi! My name\'s Harrison. I like to code, DJ, think about aesthetics, and surf the internet forever. ∞</p></div><div class="col-md-1">&nbsp;</div><div class="col-md-1 about-icon-extra"><a href="http://takemeback.to/29-November-1991#.VMZtpErF9At" target="_blank"><img src="images/clock.png">  </a></div><div class="col-md-2 about-icon-extra"><a href="http://takemeback.to/29-November-1991#.VMZtpErF9At" target="_blank" class="about-icon-link">23<br>years</a></div></div><div class="row"><div class="col-md-8 about-main"><p>I\'m currently pursuing an M.S. in CS at Stanford University, where I did my undergrad in Psychology (focusing on neuroscience). </p></div><div class="col-md-1">&nbsp;</div><div class="col-md-1 about-icon"><img src="images/seattle.png"> </div><div class="col-md-2 about-icon"><p class="about-icon-link">From:<br>Seattle, WA</p></div></div><div class="row row-eq-height"><div class="col-md-8 about-main"><p>I have a passion for creating unique human-computer interaction experiences. Thanks for checking out some of my projects!  ✌</p></div><div class="col-md-1">&nbsp;</div><div class="col-md-1 about-icon-extra"><img src="images/palmtree.png"></div><div class="col-md-2 about-icon-extra"><p class="about-icon-link">At:<br>Palo Alto, CA</p></div></div><div class="row"><div class="col-md-8"><img src="images/left_arrow2.png" alt="Left Arrow">  <img src="images/emoji_magnifier.png" alt="Magnifier Emoji"> <img src="images/emoji_up.png" alt="Up Emoji">  <img src="images/emoji_100.png" alt="100 Emoji"> <img src="images/emoji_gift.png" alt="Present Emoji"></div></div></div>';
    $("#main-container").animate({
      marginTop: "0px"
    }, {queue: false, duration: 300})
    .animate({
...
dais_button.onclick = function(e) {
  ...
  .animate({
    ...
    main_container.innerHTML += "<div class='container-fluid'>"
                              ...
                              + "</div>"
                              + "</div>"
                              + "<div class='col-md-5' style='border-left:1px solid #dddddd'>"
